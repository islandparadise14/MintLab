...
public val MLDIcon.IconPointCircle: ImageVector
    get() {
        ...
        _iconPointCircle = Builder(name = "IconPointCircle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF8B95A1)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    horizontalLineTo(13.357f)
                    curveTo(14.3471f, 6.679f, 15.2963f, 7.073f, 15.9962f, 7.7732f)
                    curveTo(16.6961f, 8.4735f, 17.0895f, 9.4229f, 17.09f, 10.413f)
                    curveTo(17.0889f, 11.4027f, 16.6953f, 12.3516f, 15.9955f, 13.0514f)
